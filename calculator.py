...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.hbox_deletion = QHBoxLayout()
        ...
        self.vbox.addLayout(self.hbox_deletion)
        ...
        self.hbox_deletion.addWidget(self.b_ac)

        self.b_del = QPushButton("DEL", self)
        self.hbox_deletion.addWidget(self.b_del)
        ...
        self.hbox_operations.addWidget(self.b_multi)

        self.b_div = QPushButton("/", self)
        self.hbox_operations.addWidget(self.b_div)

        self.b_percent = QPushButton("%", self)
        self.hbox_result.addWidget(self.b_percent)

        self.b_floating = QPushButton(".", self)
        self.hbox_result.addWidget(self.b_floating)

        self.b_result = QPushButton("=", self)
        self.hbox_result.addWidget(self.b_result)

        self.b_ac.clicked.connect(lambda: self._ac())
        ...
        self.b_floating.clicked.connect(lambda: self._button("."))
    ...
    def _result(self):
        ...
        if self.op == "/":
            if self.num_2 != 0:
                ...
                self.input.setText('0')
        if self.op == "%":
            self.input.setText(str(self.num_1 / 100 * self.num_2))
        self.used = 1
        self.num_1 = float(self.input.text())
